...
import dterminado from '@/components/svg/IconDterminado.vue'
import dvertido from '@/components/svg/IconDvertido.vue'
import dmais from '@/components/svg/IconDmais.vue'
